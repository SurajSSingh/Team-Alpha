...
public class Player_Attributes : ScriptableObject
{
    ...
    public float maxDescendAngle = 120.0f; //Maximum slope angle that player can descend
    ...
    public Vector2 wallClimbVel = new Vector2(32.0f, 6.0f); //(*used to be wallClimb) Speed when performing wall climb
    public Vector2 wallJumpVel = new Vector2(7.0f, 8.0f); //(*used to be wallJump) Speed when performing wall jump
    ...
    public float dashTime = 0.2f; // Time before player regains control while performing a dash
